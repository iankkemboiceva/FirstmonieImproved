...
public class CommisionsJSON {
    ...
    public CommisionsJSON(String txnCode, String txndateTime, double agentCmsn, String status, String amount, String toAcNum, String refNumber, String fromacnum,Boolean chgb) {
    ...
    public void setchg(Boolean chgbk) {
        this.chargeback = chgbk;
    }
}