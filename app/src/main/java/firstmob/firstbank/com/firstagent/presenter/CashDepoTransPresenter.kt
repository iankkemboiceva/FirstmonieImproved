...
class CashDepoTransPresenter(internal var iLoginView: CashDepoTransContract.ILoginView?, private val getDataIntractor: MainContract.GetDataIntractor) : CashDepoTransContract.Presenter, MainContract.GetDataIntractor.OnFinishedListener {
