...
class ConfirmCashTransPresenter(internal var iLoginView: ConfirmCashTransContract.ILoginView?, private val getDataIntractor: MainContract.GetDataIntractor) : ConfirmCashTransContract.Presenter, MainContract.GetDataIntractor.OnFinishedListener {
