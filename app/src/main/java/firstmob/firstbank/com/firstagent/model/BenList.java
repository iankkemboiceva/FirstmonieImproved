...
public class BenList implements Comparable<BenList> {
    ...
    @Override
    public int compareTo(BenList o) {
        return this.benmob.compareTo(o.benmob); // dog name sort in ascending order
