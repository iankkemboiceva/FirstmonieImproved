...
class RequestRefund : AppCompatActivity(), DatePickerDialog.OnDateSetListener, AdapterView.OnItemClickListener, DateRangePickerFragment.OnDateRangeSelectedListener, InboxContract.ILoginView {
...
*/
    ...
    override fun setList(inboxlistpar: ArrayList<GetCommPerfData>) {
        ...
        aAdpt = InboxListAdapter(inboxlist, this@RequestRefund)
        lv.adapter = aAdpt
    }
